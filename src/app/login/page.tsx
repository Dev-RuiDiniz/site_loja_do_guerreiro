    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md p-8 shadow-lg">
        <div className="text-center mb-8">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-black text-[#E8DCCB]">
            <span className="font-serif text-xl">LG</span>
          </div>
        ...
        <p className="text-center text-gray-400 text-xs mt-8">
          © {new Date().getFullYear()} Loja do Guerreiro
        </p>
      </div>
    </div>
  );
